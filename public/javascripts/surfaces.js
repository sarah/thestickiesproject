var EDITABLE_SURFACE_PROPS = {submit: "change", cancel: "cancel", event : "dblclick", tooltip : "Double-click to change name", indicator : 'Saving...', placeholder : "Double-click to change name"};
